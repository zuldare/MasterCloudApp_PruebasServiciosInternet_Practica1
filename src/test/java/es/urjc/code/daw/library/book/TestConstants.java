...
public class TestConstants {
    ...
    public static final String SUENIOS_DE_ACERO_Y_NEON_TITLE = "SUEÑOS DE ACERO Y NEON";
    ...
    public static final String LA_VIDA_SECRETA_DE_LA_MENTE_TITLE = "LA VIDA SECRETA DE LA MENTE";
    ...
    public static final String CASI_SIN_QUERER_TITLE = "CASI SIN QUERER";
    public static final String TERMINAMOS_POEMAS_TITLE = "TERMINAMOS Y OTROS POEMAS SIN TERMINAR";
    public static final String LEGION_PERDIDA_TITLE = "LA LEGIÓN PERDIDA";

    public static final Long ID_1 = 1L;
    public static final Long ID_2 = 2L;

    public static final String NEW_BOOK_TITLE = "NewBook Title";
    public static final String NEW_BOOK_DESCRIPTION = "NewBook description";
